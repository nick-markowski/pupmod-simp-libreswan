...
#     application certs in /etc/pki/simp_apps/libreswan/pki
#   * If true, do *not* include SIMP's pki module, but still use pki::copy
#     to manage certs in /etc/pki/simp_apps/libreswan/pki
...
#   It defaults to /etc/pki/simp_apps/libreswan/pki.
#
# @param app_pki_key
...
class libreswan::config::pki(
  ...
  Stdlib::Absolutepath            $app_pki_dir              = '/etc/pki/simp_apps/libreswan/pki',
